    ...
    return(
        <div className="flex flex-wrap justify-center gap-8 w-full">
            ...
            <div className="w-full flex flex-wrap justify-center gap-6" action="">
                ...
                <button onClick={login} className="bg-blue-600 py-2 w-64 rounded-md mt-6 hover:cursor-pointer">Login</button>
            </div>
            <p className="text-neutral-400 text-sm" >Don't have an account? <NavLink to="/signup" className="text-blue-400">Register</NavLink></p>
