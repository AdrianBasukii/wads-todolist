            ...
            <PopupContainer>
                <div className="w-15/16 max-w-[600px] bg-neutral-900 rounded-md">
                    <div className="w-full border-b border-neutral-800 p-4 flex justify-between">
                        <input className="text-2xl rounded py-1 px-2 border border-neutral-800" onChange={(e) => setNewTitle(e.target.value)} value={newTitle} placeholder="Insert Title"/>
                    ...
                    <div className="w-full flex flex-wrap justify-center gap-4 p-4">
                        ...
                        <button onClick={handleUpdate} className="bg-blue-600 py-2 w-64 rounded-md mx-auto hover:cursor-pointer">Save</button>
                    </div>
                </div>
            </PopupContainer>
        </div>
